...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'Shree Bajar captured our wedding so beautifully. The cinematic teaser brought tears to my eyes. Absolutely world-class team and delivery was faster than promised!',
    avatar: 'RM',
