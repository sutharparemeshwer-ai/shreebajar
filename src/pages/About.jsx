          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-start">
            <div className="lg:col-span-5 space-y-4 text-left">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Most agencies pick a lane — photography or digital marketing. At Shree Bajar, we do both. We produce breathtaking 4K/8K shoots while engineering high-ROI Meta & Google campaigns, print graphics, custom web apps, SEO & ASO.
              </p>
              <p className="text-slate-500 text-sm leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8 bg-slate-900 text-white rounded-3xl p-10 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-left">
              ...
              <h3 className="text-2xl font-extrabold text-white">Want to work at Shree Bajar?</h3>
